...
require 'win-ffi/kernel32/enum/global_alloc_flags'
require 'win-ffi/kernel32/enum/heap_flags'
require 'win-ffi/kernel32/enum/local_flags'
require 'win-ffi/kernel32/enum/memory_flags'
require 'win-ffi/kernel32/enum/memory_protection_constants'
...
module WinFFI
  module Kernel32
    ...
    encoded_function 'CreateFileMapping', [:handle, :pointer, :dword, :dword, :dword, :string], :handle
    ...
    #  _In_opt_  LPCTSTR lpName,
    #  _In_      DWORD nndPreferred )
    encoded_function 'CreateFileMappingNuma', [:handle, :pointer, :dword, :dword, :dword, :string, :dword], :handle

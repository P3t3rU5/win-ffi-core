...
module WinFFI
  module User32
    SetWindowPosFlags = enum :set_windows_pos_flags, [
        ...
        # message to the window_class, even if the window_class's size is not being changed. If this flag is not specified,
        # WM_NCCALCSIZE is sent only when the window_class's size is being changed.

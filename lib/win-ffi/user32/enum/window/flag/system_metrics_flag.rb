...
module WinFFI
  module User32
    buffer = [
        ...
        :CXBORDER,       5, # The width of a window_class border, in pixels. This is equivalent to  the :CXEDGE value
        # for windows with the 3-D look.
        :CYBORDER,       6, #The height of a window_class border, in pixels. This is equivalent to the :CYEDGE value
        # for windows with the 3-D look.
        :CXDLGFRAME,     7, # This value is the same as :CXFIXEDFRAME.
        :CXFIXEDFRAME,   7, # The thickness of the frame around the perimeter of a window_class that has a caption but
        # is not sizable, in pixels. :CXFIXEDFRAME is the height of the horizontal border, and :CYFIXEDFRAME is the
        # width of the vertical border. This value is the same as :CXDLGFRAME.
        :CYDLGFRAME,     8, # This value is the same as :CYFIXEDFRAME.
        :CYFIXEDFRAME,   8, # The thickness of the frame around the perimeter of a window_class that has a caption but
        # is not sizable, in pixels. :CXFIXEDFRAME is the height of the horizontal border, and :CYFIXEDFRAME is the
        ...
        :CXHTHUMB,      10, # The width of the thumb box in a horizontal scroll bar, in pixels.
        :CXICON,        11, # The default width of an icon, in pixels. The LoadIcon function can load only icons with
        # the dimensions that :CXICON and :CYICON specifies.
        :CYICON,        12, # The default height of an icon, in pixels. The LoadIconfunction can load only icons with
        # the dimensions :CXICON and :CYICON
        ...
        :CYFULLSCREEN,  17, # The height of the client area for a full-screen window_class on the primary display
        # monitor, in pixels. To get the coordinates of the portion of the screen not obscured by the system taskbar or
        ...
        :CXSIZEFRAME,   32, # The thickness of the sizing border around the perimeter of a window_class that can be
        # resized, in pixels. :CXSIZEFRAME is the width of the horizontal border, and :CYSIZEFRAME is the height of the
        # vertical border. This value is the same as :CXFRAME.
        :CYFRAME,       33, # This value is the same as :CYSIZEFRAME.
        :CYSIZEFRAME,   33, # The thickness of the sizing border around the perimeter of a window_class that can be
        # resized, in pixels. :CXSIZEFRAME is the width of the horizontal border, and :CYSIZEFRAME is the# height of the
        # vertical border. This value is the same as :CYFRAME.
        :CXMINTRACK,    34, # The minimum tracking width of a window_class, in pixels. The user cannot drag the
        # window_class frame to a size smaller than these dimensions. A window_class  can override this value by
        # processing the WM_GETMINMAXINFO message.
        :CYMINTRACK,    35, # The minimum tracking height of a window_class, in pixels. The user cannot drag the
        # window_class frame to a size smaller than these dimensions. A window_class can override this value by
        # processing the WM_GETMINMAXINFO message.
        ...
        :CXMINSPACING,  47, # The width of a grid cell for a minimized window_class, in pixels. Each
        # minimized window_class fits into a rectangle this size when arranged. This # value is always greater than or
        # equal to :CXMINIMIZED.
        :CYMINSPACING, 48, # The height of a grid cell for a minimized window_class, in pixels.Each minimized
        # window_class fits into a rectangle this size when arranged. This value is always greater than or equal to
        # :CYMINIMIZED.
        :CXSMICON,     49, # The recommended width of a small icon, in pixels. Small icons typically appear in
        # window_class captions and in small icon view.
        :CYSMICON,     50, # The recommended height of a small icon, in pixels. Small icons typically appear in
        # window_class captions and in small icon view.
        ...
        :CXMENUSIZE,   54, # The width of menu bar buttons, such as the child window_class close button that is used in
        # the multiple document interface, in pixels.
        :CYMENUSIZE,   55, # The height of menu bar buttons, such as the child window_class close button that is used in
        # the multiple document interface, in pixels.
        ...
        :CXMAXTRACK,   59, # The default maximum width of a window_class that has a caption and  sizing borders, in
        # pixels. This metric refers to the entire desktop. The user cannot drag the window_class frame to a size larger
        # than these dimensions. A window_class can override this value by processing the WM_GETMINMAXINFO message.
        :CYMAXTRACK,   60, # The default maximum height of a window_class that has a caption and sizing borders, in
        # pixels. This metric refers to the entire desktop. The user cannot drag the window_class frame to a size larger
        # than these dimensions. A window_class can override this value by# processing the WM_GETMINMAXINFO message.
        ...
        :CLEANBOOT,    67, # The value that specifies how the system is started:
        # 0 Normal boot
        # 1 Fail-safe boot
    ...
    if WindowsVersion >= :xp
      buffer += [
          ...
          :STARTER,     88, # Nonzero if the current operating system is Windows 7 Starter Edition, Windows Vista
      ...
      if WindowsVersion >= :vista
        ...
        if WindowsVersion >= 7
          buffer += [
              :DIGITIZER,      94, # Nonzero if the current operating system is Windows 7 or Windows Server 2008 R2 and
              # the Tablet PC Input service is started; otherwise, 0. The return value is a bitmask that specifies the
              # type of digitizer input supported by the device.
          ...
          if WindowsVersion >= 8
            buffer += [
                ...
                :SYSTEMDOCKED,         0x2004, # Reflects the state of the docking mode, 0 for Undocked Mode and nonzero

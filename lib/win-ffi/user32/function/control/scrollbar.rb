...
require 'win-ffi/user32/struct/control/scrollbar_info'
require 'win-ffi/user32/struct/control/scroll_info'

require 'win-ffi/user32/enum/scroll_window_flags'
...
module WinFFI
  module User32
    ...
    #  _In_  UINT wSBflags,
    #  _In_  UINT wArrows )
    attach_function 'EnableScrollBar', [:hwnd, EnableScrollBarFlags, :uint], :bool

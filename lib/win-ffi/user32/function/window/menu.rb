...
require 'win-ffi/user32/enum/window/menu_flags'
...
require 'win-ffi/user32/struct/window/menubar_info'
require 'win-ffi/user32/struct/window/menu_info'
require 'win-ffi/user32/struct/window/menu_item_info'
require 'win-ffi/user32/struct/window/menu_item_template'
require 'win-ffi/user32/struct/window/tpm_params'
...
module WinFFI
  module User32
    ...
    #  _In_      UINT_PTR uIDNewItem,
    #  _In_opt_  LPCTSTR lpNewItem )
    encoded_function 'InsertMenu', [:hmenu, :uint, MenuFlags, :ulong, :string], :bool

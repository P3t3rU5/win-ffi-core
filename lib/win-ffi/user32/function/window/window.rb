...
require 'win-ffi/user32/enum/window/animate_window_flags'
require 'win-ffi/user32/enum/window/get_window_flags'
require 'win-ffi/user32/enum/window/set_window_pos_flags'
require 'win-ffi/user32/enum/window/show_window_flags'
require 'win-ffi/user32/enum/window/system_metrics_flags'
require 'win-ffi/user32/enum/window/track_popup_menu_flags'
require 'win-ffi/user32/enum/window/style/window_style'
require 'win-ffi/user32/enum/window/style/window_style_ex'
require 'win-ffi/user32/enum/get_ancestor_flags'
require 'win-ffi/user32/enum/message_filter'

require 'win-ffi/general/struct/rect'
require 'win-ffi/user32/struct/window/alt_tab_info'
require 'win-ffi/user32/struct/window/flashw_info'
require 'win-ffi/user32/struct/window/gui_thread_info'
require 'win-ffi/user32/struct/window/update_layered_window_info'
require 'win-ffi/user32/struct/window/title_bar_info'

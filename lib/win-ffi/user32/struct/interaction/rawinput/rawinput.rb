...
require 'win-ffi/user32/enum/rawinput/rawinput_type'
require 'win-ffi/user32/enum/rawinput/rawinput_device_flags'
require 'win-ffi/user32/enum/rawinput/rawinput_mouse_state'
require 'win-ffi/user32/enum/rawinput/rawinput_mouse_flags'
require 'win-ffi/user32/enum/rawinput/rawinput_keyboard_flags'
